...
def generate_launch_description():
    ...
    controllers_yaml = load_yaml('ur_robot_driver', 'resources/move_group/controllers.yaml')
    ...
    # RViz
    rviz_config_file = get_package_share_directory('ur_robot_driver') + "/resources/run_move_group.rviz"
